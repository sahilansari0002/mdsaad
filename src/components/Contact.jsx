...
import { Mail, PhoneCall, Send, CheckCircle2, MessageSquare } from 'lucide-react';
...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success || apiKey === "YOUR_WEB3FORMS_ACCESS_KEY") {
        setStatus('success');
        confetti({
          particleCount: 80,
          spread: 70,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="bg-dark-card border border-dark-border rounded-2xl p-8 space-y-6 shadow-xl">
              ...
              <p className="text-xs font-sans text-dark-muted leading-relaxed">
                Have a project brief, raw footage, or a quick question? Reach out through any of these platforms:
              </p>
          ...
          <div className="lg:col-span-7">
            <form onSubmit={handleSubmit} className="bg-dark-card border border-dark-border rounded-2xl p-8 space-y-6 shadow-xl">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  ...
                  >
                    ...
                    <option value="Other Edit">Other Edit</option>
                  </select>
                </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  placeholder="Tell me about your project, footage length, deadline..."
                  className="w-full bg-dark-bg border border-dark-border rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-brand-amber transition-colors"
                />
              </div>
              ...
              <button
                ...
                data-cursor="expand"
                className="w-full bg-brand-amber hover:bg-yellow-400 text-black font-mono text-xs font-bold py-4 rounded-xl flex items-center justify-center gap-2 transition-all shadow-glow-amber disabled:opacity-50"
              >
                {status === 'idle' && (
                  <>
